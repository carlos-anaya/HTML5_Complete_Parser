...
public class Tag_open_state implements ITokenizerState {
	...
	public ParserContext process(ParserContext context) {
		...
		if (tokenizerContext.getCurrentASCIICharacter() == ASCIICharacter.LATIN_CAPITAL_LETTER) {
		...
		// yet; further details will be filled in before it is emitted.)
		if (tokenizerContext.getCurrentASCIICharacter() == ASCIICharacter.LATIN_SMALL_LETTER) {
			Token currentToken = new Token(TokenType.start_tag, currentChar);
