...
public class TagToken extends Token {
	...
	public void appendCharacterInNameInLastAttribute(int character) {
		appendCharacterInName(lasttAttribute, String.valueOf(Character.toChars(character)));
	}
	...
	public void appendCharacterInValueInLastAttribute(int character) {
		appendCharacterInValue(lasttAttribute, String.valueOf(Character.toChars(character)));
	}
